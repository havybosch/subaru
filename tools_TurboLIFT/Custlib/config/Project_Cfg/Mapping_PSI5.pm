...
$Defaults->{'PSI5_SENSORS_PROJECT'} = {
	'UFSD' => {
		...
		'INIT2_DATA' => {
			...
			SERIES_NUMBER                => '0x9876543211AB',                        # Data 21 .. 32
	...
	'PASFD' => {
		...
		'INIT2_DATA' => {
			...
			LOT_NUMBER                   => '0x0',                                   # Data 19
			LINE_NUMBER                  => '0x0',                                   # Data 20
			SERIES_NUMBER                => '0x9876543222AB',                        # Data 21 .. 32
	...
	'PASFP' => {
		...
		'INIT2_DATA' => {
			...
			LOT_NUMBER                   => '0x0',                                   # Data 19
			LINE_NUMBER                  => '0x0',                                   # Data 20
			SERIES_NUMBER                => '0x9876543330AB',                        # Data 21 .. 32
	...
	'PPSFD' => {
		...
		'INIT2_DATA' => {
			...
			SERIES_NUMBER                 => '0x9876543244AB',                 # Data 21 .. 32
		},
		'INIT3_DATA' => {
	...
	'PPSFP' => {
		...
		'INIT2_DATA' => {
			...
			LINE_NUMBER                   => '0x8',                            # Data 19
			LOT_NUMBER                    => '0x9',                            # Data 20
			SERIES_NUMBER                 => '0x9876543255AB',                 # Data 21 .. 32
		},
		'INIT3_DATA' => {
			'INIT3_MESSAGE'           => 'SENSOR_OK',
			'ABSOLUTE_PRESSURE_VALUE' => 10,
