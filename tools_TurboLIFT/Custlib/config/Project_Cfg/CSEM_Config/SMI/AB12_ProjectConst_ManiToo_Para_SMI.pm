...
#------------------------------------------------------------------------------------------------
# Config: SMI8_6D_C7 (CA RefType4 ECU)
#------------------------------------------------------------------------------------------------
#SMI860 (InertialSensor1)
my $RollRateLfChl = '50 00 00 00';    #RollRateLfChl		Rate1
my $AccYLgChl     = '60 00 00 00';    #AccYLgChl          ACC1
my $AccYHgMonChl  = '68 00 00 00';    #AccYHgMonChl       ACC1
my $AccXLgChl     = '70 00 00 00';    #AccXLgChl			ACC2
my $AccXHgMonChl  = '78 00 00 00';    #AccXHgMonChl       ACC2
my $YawRateLfChl  = 'D0 00 00 00';    #YawRateLfChl		Rate2
my $AccZLgChl     = 'F0 00 00 00';    #AccZLgChl          ACC3

#SMI810 (InertialSensor2)
my $PitchRateLfChl = '90 00 00 00';    #PitchRateLfChl		Rate1
#SCON_MON
my $RollRateLfChl_Ext  = '52 00 00 00';    #RollRateLfChl
my $PitchRateLfChl_Ext = '92 00 00 00';    #PitchRateLfChl
...
my $SMA_SensorMask = 'C0 00 00 00';
my $SMA_Channel_0  = '80 00 00 00';
my $SMA_Channel_1  = 'C0 00 00 00';
...
#my $FieldCalibSyncTime = '40 02 E6 30';  #190 ms  #new
my $FieldCalibSyncTime = '40 10 A1 D0';    #1090 ms  #new
...
# Bit 1..0    Acc1 HF -> AccYHg or AccXHg
my $SMI7_ACC1_HF_StatHwScon_01 = '00 00 00 08';    #               	710_2-AccXHg     705_1_AccYHg     705_1-AccYHg
my $SMI7_ACC1_HF_StatHwScon_10 = '00 00 00 10';    #
my $SMI7_ACC1_HF_StatHwScon_11 = '00 00 00 18';    #

# Bit 3..2    Acc1 LF -> AccYLg or AccXLg
my $SMI7_ACC1_LF_StatHwScon_01 = '00 00 00 20';    #  700_1-AccYLg     700_1-AccYLg     705_1_AccYLg     705_1-AccYLg
my $SMI7_ACC1_LF_StatHwScon_10 = '00 00 00 40';    #  700_2-AccYLgP   	700_2-AccYLgP
my $SMI7_ACC1_LF_StatHwScon_11 = '00 00 00 60';    #               	710_2-AccXLg

# Bit 5..4    Acc2 HF -> AccXHg or AccYHg
my $SMI7_ACC2_HF_StatHwScon_01 = '00 00 00 80';    #  700_1-AccXHg     	             715_1_AccXHg     715_1-AccXHg
my $SMI7_ACC2_HF_StatHwScon_10 = '00 00 01 00';    #
my $SMI7_ACC2_HF_StatHwScon_11 = '00 00 01 80';    #

# Bit 7..6    Acc2 LF -> AccXLg or AccYLg
my $SMI7_ACC2_LF_StatHwScon_01 = '00 00 02 00';    #  700_1-AccXLg                      715_1_AccXLg     715_1-AccXLg
my $SMI7_ACC2_LF_StatHwScon_10 = '00 00 04 00';    #  710_1-AccZLg     710_2-AccZLg     705_1_AccZLg     705_1-AccZLg
my $SMI7_ACC2_LF_StatHwScon_11 = '00 00 06 00';    #

# Bit 9..8    Rate HF (not used)
...
# Bit 11..10  Rate LF -> Yaw or Roll or Pitch
my $SMI7_RATE_LF_StatHwScon_01 = '00 00 20 00';    #  700_1-Yaw		700_1-Yaw        705_1-Yaw        705_1-Yaw
my $SMI7_RATE_LF_StatHwScon_10 = '00 00 40 00';    #  715_1-Roll       710_1-Roll       715_1-Roll       715_1-Roll
my $SMI7_RATE_LF_StatHwScon_11 = '00 00 60 00';    #   		   	    710_2-Pitch                       715_2-Pitch
                                                   #  700_2-YawP       700_2-YawP

#   ************ REMARK !! ************
#Directions:
#ax: can be Acc1 OR Acc2 for SMI700 and SMI715
#	 always Acc1, because az is always Acc2 (for SMI710 and SMI705)

#ay: can be Acc1 OR Acc2 for SMI700 and SMI715
#	 always Acc1, because az is always Acc2 (for SMI710 and SMI705)

# THIS HAS INPACT TO THE PARAMETER SPECIFICATION IN DOORS
# for the test cases which manipulate the
# - CHANNEL_STATUS_HW_SCON register   (Page 1, Address 8)
# - error_group_out register          (Page 2, Address 15,  16 Bit Cluster Flags))

# Search in TS for manipulation parameter containing '_Overload' or _ChlStatHwScon'
# and assign the corresponding sensor depending on the ECU mounting direction
...
#-------------------------------
# SMI860, SMG810, SMI8 C-sample                (not Core Asset)      (Core Asset RT4)
#-------------------------------               ----------------    ---------------------
#                                                   SMI800         SMI860         SMG810
#Config SMI_3D_C5:                                     x
#Config SMI_5D_C6:                                                   x                     SMI860: Acc1->Y, Acc2->X, Acc3->Z, Rate2-> Yaw, Rate1->Roll
#Config SMI_5D_C7                                                    x             x       SMI860: Acc1->Y, Acc2->X, Acc3->Z, Rate2-> Yaw, Rate1->Roll,  SMI810: Rate1->Pitch

# Bit 1..0    Acc1 -> AccYHg or AccXHg
my $SMI8_ACC1_HF_StatHwScon_01 = '00 00 00 08';    # AccXHg         # AccYHg
my $SMI8_ACC1_HF_StatHwScon_10 = '00 00 00 10';    # (AccYHg)       # (AccXHg)
my $SMI8_ACC1_HF_StatHwScon_11 = '00 00 00 18';    #                #

# Bit 3..2    Acc1 -> AccYLg or AccXLg
my $SMI8_ACC1_LF_StatHwScon_01 = '00 00 00 20';    # AccXLg         # AccYLg
my $SMI8_ACC1_LF_StatHwScon_10 = '00 00 00 40';    # (AccYLg)       # (AccXLg)
my $SMI8_ACC1_LF_StatHwScon_11 = '00 00 00 60';    #                #

# Bit 5..4    Acc2 -> AccXHg or AccYHg
my $SMI8_ACC2_HF_StatHwScon_01 = '00 00 00 80';    # AccYHg         # AccXHg
my $SMI8_ACC2_HF_StatHwScon_10 = '00 00 01 00';    # (AccXHg)       # (AccYHg)
my $SMI8_ACC2_HF_StatHwScon_11 = '00 00 01 80';    #                #

# Bit 7..6    Acc2 -> AccXLg or AccYLg
my $SMI8_ACC2_LF_StatHwScon_01 = '00 00 02 00';    # AccYLg         # AccXLg
my $SMI8_ACC2_LF_StatHwScon_10 = '00 00 04 00';    # (AccXLg)       # (AccXLg)
my $SMI8_ACC2_LF_StatHwScon_11 = '00 00 06 00';    #                #

# Bit 9..8    Rate2 -> Yaw
my $SMI8_RATE2_LF_StatHwScon_01 = '00 00 08 00';    # Yaw            # Yaw
my $SMI8_RATE2_LF_StatHwScon_10 = '00 00 10 00';    #                #
my $SMI8_RATE2_LF_StatHwScon_11 = '00 00 18 00';    #                #

# Bit 11..10  Rate1 -> Roll or Pitch
my $SMI8_RATE1_LF_StatHwScon_01 = '00 00 20 00';    # Roll         # Pitch
my $SMI8_RATE1_LF_StatHwScon_10 = '00 00 40 00';    # (Pitch)      # (Roll)
my $SMI8_RATE1_LF_StatHwScon_11 = '00 00 60 00';    #              #

# Bit 13..12  Acc3 (not used)
#my $SMI8_ACC3_HF_StatHwScon_01  = '00 00 80 00';
#my $SMI8_ACC3_HF_StatHwScon_10  = '00 01 00 00';
#my $SMI8_ACC3_HF_StatHwScon_11  = '00 01 80 00';
# Bit 15..14  Acc3 -> AccZLg
...
#   ************ REMARK ************
# Depemding on the mounting direction of the ECU
# Acc1  can be: X-signal or Y-signal
# Acc2  can be: Y-signal or X-signal
# Rate1 can be: Roll     or Pitch
...
# Search in TS for manipulation parameter containing '_Overload' or _ChlStatHwScon'
# and assign the correc Acc1, Acc2 or Rate channel depending on the ECU mounting direction
...
#---------------------------
my $InertialSensor2_Page0 = '00 01 00 00';
my $InertialSensor2_Page1 = '00 02 00 00';
my $InertialSensor2_Page2 = '00 04 00 00';
my $InertialSensor2_Page4 = '00 10 00 00';
#
my $InertialSensor2_Addr0x0 = '88 00 00 00';
my $InertialSensor2_Addr0x1 = '88 80 00 00';
my $InertialSensor2_Addr0x2 = '89 00 00 00';
my $InertialSensor2_Addr0x3 = '89 80 00 00';
my $InertialSensor2_Addr0x4 = '8A 00 00 00';
my $InertialSensor2_Addr0x5 = '8A 80 00 00';
my $InertialSensor2_Addr0x6 = '8B 00 00 00';
my $InertialSensor2_Addr0x7 = '8B 80 00 00';
my $InertialSensor2_Addr0x8 = '8C 00 00 00';
my $InertialSensor2_Addr0x9 = '8C 80 00 00';
my $InertialSensor2_Addr0xA = '8D 00 00 00';
my $InertialSensor2_Addr0xB = '8D 80 00 00';
my $InertialSensor2_Addr0xC = '8E 00 00 00';
my $InertialSensor2_Addr0xD = '8E 80 00 00';
my $InertialSensor2_Addr0xE = '8F 00 00 00';
my $InertialSensor2_Addr0xF = '8F 80 00 00';
...
$Defaults->{'PARA_MAP_SMI'}{'TESTCASES'} = {
    ...
    'InertialSensor1_ClusterFlags' => {
        'CMD_sequence' => {
            2.3 => { cmd => '33 - 02 - ' . $InertialSensor1_Addr0xF, descr => 'Addr: error_group_out InertialSensor1_Addr0xF' },
            2.4 => { cmd => '72 - 02 - ' . $InertialSensor1_Page2,   descr => 'Page: error_group_out InertialSensor1_Page2' },
        },
    },
    'InertialSensor2_ClusterFlags' => {
        'CMD_sequence' => {
            2.3 => { cmd => '33 - 02 - ' . $InertialSensor2_Addr0xF, descr => 'Addr: error_group_out InertialSensor2_Addr0xF' },
    ...
    'InertialSensor1_ErrorFlag16_Bank0' => {
        'CMD_sequence' => {
            1.3 => { cmd => '33 - 00 - ' . $InertialSensor1_Addr0x1, descr => 'Addr: error_flag_16_bank0 InertialSensor1_Addr0x1' },
    ...
    'InertialSensor2_ErrorFlag16_Bank0' => {
        'CMD_sequence' => {
            1.3 => { cmd => '33 - 00 - ' . $InertialSensor2_Addr0x1, descr => 'Addr: error_flag_16_bank0 InertialSensor2_Addr0x1' },
    ...
    'InertialSensor1_ErrorFlag16_Bank1' => {
        'CMD_sequence' => {
            2.3 => { cmd => '33 - 00 - ' . $InertialSensor1_Addr0x2, descr => 'Addr: error_flag_16_bank1 InertialSensor1_Addr0x2' },
    ...
    'InertialSensor2_ErrorFlag16_Bank1' => {
        'CMD_sequence' => {
            2.3 => { cmd => '33 - 00 - ' . $InertialSensor2_Addr0x2, descr => 'Addr: error_flag_16_bank1 InertialSensor2_Addr0x2' },
    ...
    'InertialSensor2_ErrorFlag16_Bank7' => {
        'CMD_sequence' => {
            1.3 => { cmd => '33 - 00 - ' . $InertialSensor2_Addr0x8, descr => 'Addr: error_flag_16_bank7 InertialSensor2_Addr0x8' },
    ...
    'InertialSensor1_ErrorFlag16_Bank9' => {
        'CMD_sequence' => {
            1.3 => { cmd => '33 - 00 - ' . $InertialSensor1_Addr0xA, descr => 'Addr: error_flag_16_bank7 InertialSensor1_Addr0x8' },
            1.4 => { cmd => '72 - 00 - ' . $InertialSensor1_Page2,   descr => 'Page: error_flag_16_bank7 InertialSensor1_Page2' },
        },
    },
    'InertialSensor2_ErrorFlag16_Bank9' => {
        'CMD_sequence' => {
            1.3 => { cmd => '33 - 00 - ' . $InertialSensor2_Addr0xA, descr => 'Addr: error_flag_16_bank7 InertialSensor2_Addr0x8' },
            1.4 => { cmd => '72 - 00 - ' . $InertialSensor2_Page2,   descr => 'Page: error_flag_16_bank7 InertialSensor2_Page2' },
        },
    },
    ...
    #************************************************************************************
    'Set_Data_AccXLgChl_Relative_Offset_Test_T3' => {
        'CMD_sequence' => {
    ...
    #************************************************************************************
    'Set_Data_AccYLgChl_Relative_Offset_Test_T3' => {
        'CMD_sequence' => {
    ...
    #************************************************************************************
    'Set_Data_AccZLgChl_Relative_Offset_Test_T3' => {
        'CMD_sequence' => {
            2.6 => { cmd => '41 - 00 - 07 - 10 00 00 FF - 10 00 00 FF - 10 00 00 FF - 10 00 00 FF - 10 00 00 FF - 10 00 00 FF - 10 00 01 FF', descr => 'Mode: SCM' },
            2.7 => { cmd => '42 - 00 - 07 - 00 0F FF 80 - 00 0F FF 80 - 00 0F FF 80 - 00 0F FF 80 - 00 0F FF 80 - 00 0F FF 80 - 00 0F FF F0', descr => 'Ctrl: Set_Data_AccZLgChl_Relative_Offset_Test_T3' },
    ...
    #************************************************************************************
    'Set_Data_AccXLgChl_Relative_Offset_Test_T2' => {
        'CMD_sequence' => {
    ...
    #************************************************************************************
    'Set_Data_AccYLgChl_Relative_Offset_Test_T2' => {
        'CMD_sequence' => {
    ...
    #************************************************************************************
    'Set_Data_AccZLgChl_Relative_Offset_Test_T2' => {
        'CMD_sequence' => {
    ...
    #************************************************************************************
    'Set_Data_AccXLgChl_Relative_Offset_Test_T1' => {
        'CMD_sequence' => {
    ...
    #************************************************************************************
    'Set_Data_AccYLgChl_Relative_Offset_Test_T1' => {
        'CMD_sequence' => {
    ...
    #************************************************************************************
    'Set_Data_AccZLgChl_Relative_Offset_Test_T1' => {
        'CMD_sequence' => {
...
'43 - 00 - 16 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 - 00 08 30 00 - 00 0F E0 C0 ',
    ...
    'InertialSensor1_error_cnt_comb2_Read' => {
        'CMD_sequence' => {
            ...
            # Configure SPI trigger for SMI860/800 Read_IntErrCnt45
            0.1 => { cmd => '31 - 00 - ' . $SMI_SPI1_CS3,            descr => 'Set SPI1 to SMI7_CS' },
            0.2 => { cmd => '32 - 00 - ' . $SMI_StandardMask,        descr => 'Set SPI to SMI7_ModuleMask' },
            0.3 => { cmd => '33 - 00 - ' . $InertialSensor1_Addr0xD, descr => 'Set SPI Pattern to YawSensor_Addr0xD' },
            0.4 => { cmd => '72 - 00 - ' . $InertialSensor1_Page2,   descr => 'Select SMI7 YawSensor_Page2' },
    ...
    'InertialSensor2_error_cnt_comb2_Read' => {
        'CMD_sequence' => {
            ...
            # Configure SPI trigger for SMI810 Read_IntErrCnt45
            0.1 => { cmd => '31 - 00 - ' . $SMI_SPI1_CS3,            descr => 'Set SPI1 to SMI7_CS' },
            0.2 => { cmd => '32 - 00 - ' . $SMI_StandardMask,        descr => 'Set SPI to SMI7_ModuleMask' },
            0.3 => { cmd => '33 - 00 - ' . $InertialSensor2_Addr0xD, descr => 'Set SPI Pattern to YawSensor_Addr0xD' },
            0.4 => { cmd => '72 - 00 - ' . $InertialSensor2_Page2,   descr => 'Select SMI7 YawSensor_Page2' },
    ...
    # 'CMD_sequence' => {
    # # Set trigger value           	   166 ms       950 ms       1200 ms       1000 ms       1300 ms
    # 0.6 => { cmd => '41 - 00 - 05 - 40 02 88 70 - 40 0E 7E F0 - 40 12 4F 80 - 40 0F 42 40 - 40 13 D6 20', descr => '166ms, 950 ms, 1200 ms, 1000 ms, 1300 ms' },
    # },
    # },
    ...
    'RateLfChl_FieldCalib_Basic_Test' => {
        'CMD_sequence' => {
            0.7 => { cmd => '42 - 00 - 05 - 00 00 0F F0 - 00 0F FF F0 - 00 0F FF F0 - 00 0F FF F0 - 00 0F FF F0', descr => 'DATA' },
            0.8 => { cmd => '43 - 00 - 05 - 00 00 00 00 - 00 01 1F F0 - 00 00 12 C0 - 00 00 00 00 - 00 00 13 C0', descr => 'Write FIFO data' },
        },
    },
...
#------------------------------------------------------------------------
# SMI700
my $YawRateLfChl  		= '50 00 00 00';    #YawRateLfChl		Rate
my $AccYLgChl     		= '60 00 00 00';    #AccYLgChl     		ACC1
my $AccYHgMonChl		= '68 00 00 00';    #AccYHgMonChl  		ACC1
my $AccXLgChl     		= '70 00 00 00';    #AccXLgChl     		ACC2
my $AccXHgMonChl  		= '78 00 00 00';    #AccXHgMonChl  		ACC2
...
my $AccXHgMonChl  		= '78 00 00 00';    #AccXHgMonChl  		ACC2
# SMI710
my $RollRateLfChl		= 'D0 00 00 00';    #RollRateLfChl		Rate
my $AccZLgChl			= 'F0 00 00 00';    #AccZLgChl     		ACC2

#SCON_MON
my $RollRateLfChl_Ext   = 'D2 00 00 00';    #RollRateLfChl
...
#------------------------------------------------------------------------
# Config: SMI7_5DR_C1 (not used in projects)
#------------------------------------------------------------------------
# SMI700
my $YawRateLfChl  		= '50 00 00 00';    #YawRateLfChl		Rate
my $AccYLgChl     		= '60 00 00 00';    #AccYLgChl     		ACC1
...
my $AccZLgChl     		= 'F0 00 00 00';    #AccZLgChl     		ACC2
# SMI700
my $YawRateLfPlausiChl	= '10 00 00 00';    #YawRateLfPlausiChl Rate
my $AccYLgPlausiChl		= '20 00 00 00';    #AccYLgPlausiChl	ACC1
...
#------------------------------------------------------------------------
# Config: SMI7_6DR_C2 (not used in projects)
#------------------------------------------------------------------------
#SMI700_1
my $YawRateLfChl  		= '50 00 00 00';    #YawRateLfChl		Rate
my $AccYLgChl     		= '60 00 00 00';    #AccYLgChl			ACC1
my $AccYHgMonChl		= '68 00 00 00';	#AccHHgMonChl		ACC1
# SMI710_1
my $RollRateLfChl 		= 'D0 00 00 00';    #RollRateLfChl		Rate
# SMI700_2
...
my $AccYLgPlausiChl     = '20 00 00 00';    #AccYLgPlausiChl	ACC1
#SMI710_2
my $PitchRateLfChl		= '90 00 00 00';    #PitchRateLfChl		Rate
my $AccXLgChl     		= 'A0 00 00 00';    #AccXLgChl			ACC1
my $AccXHgMonChl  		= 'A8 00 00 00';    #AccXHgMonChl		ACC1
my $AccZLgChl     		= 'B0 00 00 00';    #AccZLgChl			ACC2
...
#------------------------------------------------------------------------
# Config: SMI7_5D_C3 (CA RefType3.2 ECU)
#------------------------------------------------------------------------
# SMI705
my $YawRateLfChl  		= '50 00 00 00';    #YawRateLfChl		Rate
my $AccYLgChl     		= '60 00 00 00';    #AccYLgChl			ACC1
my $AccYHgMonChl  		= '68 00 00 00'; 	#AccYHgMonChl       ACC1
my $AccZLgChl     		= '70 00 00 00';    #AccZLgChl			ACC2
# SMI715
my $RollRateLfChl 		= 'D0 00 00 00';    #RollRateLfChl		Rate
my $AccXLgChl     		= 'F0 00 00 00';    #AccXLgChl			ACC2
my $AccXHgMonChl  		= 'F8 00 00 00';    #AccXHgMonChl		ACC2
...
#------------------------------------------------------------------------
# Config: SMI8_3D_C5 (CA RefType4 ECU)
#------------------------------------------------------------------------
#SMI800 (InertialSensor1)
my $YawRateLfChl  		= '50 00 00 00';    #YawRateLfChl		Rate
my $AccYLgChl     		= '60 00 00 00';    #AccYLgChl          ACC1
my $AccYHgMonChl  		= '68 00 00 00';    #AccYHgMonChl       ACC1
my $AccXLgChl     		= '70 00 00 00';    #AccXLgChl			ACC2	
...
#------------------------------------------------------------------------
# Config: SMI8_5D_C6 (CA RefType4 ECU)
#------------------------------------------------------------------------
#SMI860 (InertialSensor1)
my $RollRateLfChl		= '50 00 00 00';    #RollRateLfChl		Rate1
my $AccYLgChl     		= '60 00 00 00';    #AccYLgChl          ACC1
