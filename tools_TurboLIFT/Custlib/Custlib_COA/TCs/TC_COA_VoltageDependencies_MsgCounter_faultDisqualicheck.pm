#### TEST CASE MODULE
package TC_COA_VoltageDependencies_MsgCounter_faultDisqualicheck;
...
our $HEADER  = q$Header: TCs/TCs_Project/CAN/TC_COA_VoltageDependencies_MsgCounter_faultDisqualicheck.pm 1.1 2016/08/26 16:14:33ICT pnv5kor develop  $;
...
TC_COA_VoltageDependencies_MsgCounter_faultDisqualicheck
...
10.<ReadDTCResp>  should be observed.
...
sub TC_stimulation_and_measurement {
	...
	S_teststep( "Send '$tcpar_Req_DTCstatus' with StatusMask is FF", 'AUTO_NBR', 'send_req_readdtc_A' );    #measurement 1
	...
	S_teststep( "Send '$tcpar_Req_DTCstatus' with StatusMask is FF", 'AUTO_NBR', 'send_req_readdtc_B' );    #measurement 2
	...
	S_teststep( "Send '$tcpar_Req_DTCstatus' with StatusMask is FF", 'AUTO_NBR', 'send_req_readdtc_C' );     #measurement 3
	$res3 = GDCOM_request($tcpar_Req_DTCstatus, $tcpar_ReadDTCResp, 'strict' );
...
sub TC_evaluation {
	...
	S_teststep_expected( "'$tcpar_ReadDTCResp'  should be observed.", 'send_req_readdtc_C' );                             #evaluation 3
	S_teststep_detected( "DTC response is obtained $res3", 'send_req_readdtc_C' );
	EVAL_evaluate_string( "DTC response Check", $tcpar_ReadDTCResp, $res3);
