#### TEST CASE MODULE
package TC_COA_LOCFaulDequalicheck_Sporadic;
...
our $HEADER  = q$Header: TCs/TCs_Project/CAN/TC_COA_LOCFaulDequalicheck_Sporadic.pm 1.1 2016/08/26 16:14:31ICT pnv5kor develop  $;
...
our $PURPOSE = "To check the lost of communication fault dequalification check when the message is transmitted sporadically";

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> DOCUMENTATION >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

=head1 TESTCASE MODULE

TC_COA_LOCFaulDequalicheck_Sporadic
...
9. Check the signal ABG33A_2_0_IND_WARN_ABG in MSG ABG33A.
...
9. The value of signal ABG33A_2_0_IND_WARN_ABG is set to 0
...
sub TC_initialization {
	...
	S_teststep( "1.Continue from TS_COA_480.", 'AUTO_NBR' );
...
sub TC_stimulation_and_measurement {
	...
	S_teststep( "Check the signal ABG33A_2_0_IND_WARN_ABG in msg ABG33A", 'AUTO_NBR', 'check_the_lampindsignal' );    #measurement 3
...
sub TC_evaluation {
	...
	S_teststep_expected( "The value ofthe signal ABG33A_2_0_IND_WARN_ABG should be 0", 'check_the_lampindsignal' );       #evaluation 3
