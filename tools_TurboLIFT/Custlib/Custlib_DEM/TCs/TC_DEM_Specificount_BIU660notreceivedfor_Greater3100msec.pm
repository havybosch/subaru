#### TEST CASE MODULE
package TC_DEM_Specificount_BIU660notreceivedfor_Greater3100msec;
...
our $PURPOSE = "check BIU660 not received";

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> DOCUMENTATION >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

=head1 TESTCASE MODULE

TC_DEM_Specificount_BIU660notreceivedfor_Greater3100msec
...
=head2 PARAMETER EXAMPLES
	...
	purpose = 'To check the trip and time counter value when the BIU660 is stopped transmitting for greater than 3100msec' # description of test case
	# input parameters
	t_wait= '4000'#wait time from IGN ON.
	fault1= 'rb_coa_TCURxMsgTimeout_flt'
	t_Qual1= '400'
	fault2= 'rb_sqm_TerminalShort2GndAB1FP_flt'
	t_Qual2= '2000'
	MSG_ID = 'BIU660'
...
sub TC_stimulation_and_measurement {
	...
	DEVICE_setDeviceState ('AB1FP', 'Short2Gnd');
	S_user_action("Created fault rb_sqm_TerminalShort2GndAB1FP_flt");
...
sub TC_finalization {
	...
	DEVICE_resetDeviceState ('AB1FP', 'Short2Gnd');
