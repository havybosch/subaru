...
$HEADER = q$Header: CAN_Panel_EOL.c 11/3/2023 4:50:35 PM Ly Kim Nguyen Ban (MS/EAA43-CC) develop $;
###This generated file is using for update CANoe file: \config\Tools\CANoe_Conf\nodes\CAN_Panel_EOL.can
###############################


void FUNC_LoadGEN_LConfiguration()
{
...
@sysvar::eol_sysvar::ENV_EOL_Bit_53=1;
@sysvar::eol_sysvar::ENV_EOL_Bit_52=1;
@sysvar::eol_sysvar::ENV_EOL_Bit_51=1;
@sysvar::eol_sysvar::ENV_EOL_Bit_50=1;
...
void FUNC_LoadEU_RConfiguration()
{
@sysvar::eol_sysvar::ENV_EOL_Bit_08=1;
@sysvar::eol_sysvar::ENV_EOL_Bit_07=1;
@sysvar::eol_sysvar::ENV_EOL_Bit_06=1;
...
void FUNC_LoadEU_LConfiguration()
{
@sysvar::eol_sysvar::ENV_EOL_Bit_08=0;
@sysvar::eol_sysvar::ENV_EOL_Bit_07=1;
@sysvar::eol_sysvar::ENV_EOL_Bit_06=1;
