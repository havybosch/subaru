#### TEST CASE MODULE
package TC_DHSWIM_MismatchFlt_FaultyPendingDisqualification;
...
our $HEADER = q$Header: TCs/TCs_Project/DHSWL/Fault_Handling/Mismatch_Fault/TC_DHSWIM_MismatchFlt_FaultyPendingDisqualification.pm 1.2 2018/08/28 13:11:28ICT UUL1HC develop  $;
...
our $PURPOSE = "Check Fault pending Disqualified";

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> DOCUMENTATION >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

=head1 TESTCASE MODULE

TC_DHSWIM_MismatchFlt_FaultyPendingDisqualification
...
4. Send message <Rx_Msg_name> at CAN ID: <Rx_Msg_ID> with Faulty signal <Rx_Sig_name> is  <Rx_Sig_value_2> for <cycles_2>.

5. Check Fault recorder.

6. Send message <Rx_Msg_name> at CAN ID: <Rx_Msg_ID> with valid signal <Rx_Sig_name> is  <Rx_Sig_value_3> for <cycles_3>.
...
sub TC_stimulation_and_measurement {
	...
	#4 Send message _HEC with faulty signal RIL_STAT		
	S_teststep("Send message '$tcpar_Rx_Msg_name' at CAN ID: '$tcpar_Rx_Msg_ID' with Faulty signal '$tcpar_Rx_Sig_name' is  '$tcpar_Rx_Sig_value_2' for '$tcpar_cycles_2' cycles.", 'AUTO_NBR');
	...
	S_teststep("Send message '$tcpar_Rx_Msg_name' at CAN ID: '$tcpar_Rx_Msg_ID' with valid signal '$tcpar_Rx_Sig_name' is  '$tcpar_Rx_Sig_value_3' for '$tcpar_cycles_3' cycles.", 'AUTO_NBR');
