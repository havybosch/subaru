#### TEST CASE MODULE
package TC_DHSWIM_NotOperationFlt_ReQualification;
...
our $HEADER = q$Header: TCs/TCs_Project/DHSWL/Fault_Handling/Not_Operation_Fault/TC_DHSWIM_NotOperationFlt_ReQualification.pm 1.2 2018/08/28 13:11:29ICT UUL1HC develop  $;
...
TC_DHSWIM_NotOperationFlt_ReQualification
...
2.Create Fault <Fault> by Send message <Rx_Msg_name> at CAN ID: <Rx_Msg_ID> with Faulty signal <Rx_Sig_name> is  <Rx_Sig_value_1> for <cycles_1> cycles .

3. Check <Fault> recorder.

4. Remove Fault condition <Fault> by Send message <Rx_Msg_name> at CAN ID: <Rx_Msg_ID> with valid signal <Rx_Sig_name> is  <Rx_Sig_value_2> for <cycles_2> cycles .

5. Check <Fault> recorder.

6. Create Fault <Fault> by Send message <Rx_Msg_name> at CAN ID: <Rx_Msg_ID> with Faulty signal <Rx_Sig_name> is  <Rx_Sig_value_1> .
...
sub TC_stimulation_and_measurement {
	...
	S_teststep("Create Fault '$tcpar_Fault' by Send message '$tcpar_Rx_Msg_name' at CAN ID: '$tcpar_Rx_Msg_ID' with Faulty signal '$tcpar_Rx_Sig_name' is  '$tcpar_Rx_Sig_value_1' for '$tcpar_cycles_1' cycles .", 'AUTO_NBR');
	...
	S_teststep("Remove Fault condition '$tcpar_Fault' by Send message '$tcpar_Rx_Msg_name' at CAN ID: '$tcpar_Rx_Msg_ID' with valid signal '$tcpar_Rx_Sig_name' is  '$tcpar_Rx_Sig_value_2' for '$tcpar_cycles_2' cycles .", 'AUTO_NBR');
		COM_setSignalState($tcpar_Rx_Sig_name, $RxLampState{$tcpar_Rx_Sig_value_2});
		S_wait_ms($tcpar_cycles_2*$RxMsgCyclicTime);
		
	#5 Check Flt
	S_teststep("Check '$tcpar_Fault' recorder.", 'AUTO_NBR', 'check_fault_recorder_B');			#measurement 2
		$flt_struct_2 = PD_ReadFaultMemory();
	
	#6 Send messagg _HEC with faulty value RIL-STAT to create Fault condition	
	S_teststep("Create Fault '$tcpar_Fault' by Send message '$tcpar_Rx_Msg_name' at CAN ID: '$tcpar_Rx_Msg_ID' with Faulty signal '$tcpar_Rx_Sig_name' is  '$tcpar_Rx_Sig_value_1' .", 'AUTO_NBR');
		COM_setSignalState($tcpar_Rx_Sig_name, $RxLampState{$tcpar_Rx_Sig_value_1});
			
	#7 Check Flt	
	S_teststep("Check Fault recorder after '$tcpar_Rx_Msg_name' transmitted for '$tcpar_cycles_3' cycles after step 6.", 'AUTO_NBR', 'check_fault_recorder_C');			#measurement 3
