#### TEST CASE MODULE
package TC_DHSWIM_NotOperationFlt_PendingDisqualification;
...
our $HEADER = q$Header: TCs/TCs_Project/DHSWL/Fault_Handling/Not_Operation_Fault/TC_DHSWIM_NotOperationFlt_PendingDisqualification.pm 1.3 2018/09/21 11:09:35ICT UUL1HC develop  $;
...
our $PURPOSE = "Check fault dequalified pending";

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> DOCUMENTATION >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>

=head1 TESTCASE MODULE

TC_DHSWIM_NotOperationFlt_PendingDisqualification
...
6. Send  message <Rx_Msg_name> at CAN ID: <Rx_Msg_ID> with <Rx_Sig_name> is  <Rx_Sig_value_2> after step 5 .
...
sub TC_stimulation_and_measurement {
	...
	S_teststep("Create Fault '$tcpar_Fault' by Send message '$tcpar_Rx_Msg_name' at CAN ID: '$tcpar_Rx_Msg_ID' with '$tcpar_Rx_Sig_name' is  '$tcpar_Rx_Sig_value_1' for '$tcpar_cycles_1' cycles .", 'AUTO_NBR', 'create_fault_fault');			#measurement 1
	...
	#3 Create condition
	S_teststep("Create '$tcpar_Condition' and wait '$tcpar_T_time'.", 'AUTO_NBR');
	...
	#4 Check flt	
	S_teststep("Check '$tcpar_Fault' recorder.", 'AUTO_NBR', 'check_fault_recorder_A');			#measurement 2
		if($tcpar_Condition eq 'Busoff'){
	...
	S_teststep("Send  message '$tcpar_Rx_Msg_name' at CAN ID: '$tcpar_Rx_Msg_ID' with '$tcpar_Rx_Sig_name' is  '$tcpar_Rx_Sig_value_2' after step 5 .", 'AUTO_NBR');
...
sub TC_evaluation {
	...
	S_teststep_detected("'$tcpar_Fault' status is '$faultStatus_1'", 'create_fault_fault');
	...
	S_teststep_detected("'$tcpar_Fault' status is '$faultStatus_2'", 'check_fault_recorder_A');
	...
	S_teststep_detected("'$tcpar_Fault' status is '$faultStatus_3", 'check_fault_recorder_B');
